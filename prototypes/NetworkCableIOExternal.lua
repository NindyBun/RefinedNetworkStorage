local ioI = {}
ioI.type = "item"
ioI.name = Constants.NetworkCables.externalIO.slateEntity.name
ioI.icon = Constants.NetworkCables.externalIO.itemEntity.itemIcon
ioI.icon_size = 512
ioI.subgroup = Constants.ItemGroup.Category.subgroup
ioI.order = "i"
ioI.place_result = Constants.NetworkCables.externalIO.slateEntity.name
ioI.stack_size = 25
data:extend{ioI}

local ioR = {}
ioR.type = "recipe"
ioR.name = Constants.NetworkCables.externalIO.slateEntity.name
ioR.energy_required = 1
ioR.enabled = true
ioR.ingredients = {}
ioR.result = Constants.NetworkCables.externalIO.slateEntity.name
ioR.result_count = 1
data:extend{ioR}
...
io.icon = Constants.NetworkCables.externalIO.itemEntity.itemIcon
io.icon_size = 512
...
io.minable = {mining_time = 0.2, result = Constants.NetworkCables.externalIO.slateEntity.name}
io.animation =
    {
        north = {
			layers = {
