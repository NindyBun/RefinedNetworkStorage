local ioI = {}
ioI.type = "item"
ioI.name = Constants.NetworkCables.externalIO.name
ioI.icon = Constants.NetworkCables.externalIO.itemIcon
ioI.icon_size = 512
ioI.subgroup = Constants.ItemGroup.Category.subgroup
ioI.order = "i"
ioI.place_result = Constants.NetworkCables.externalIO.name
ioI.stack_size = 25
data:extend{ioI}
...
local ioR = {}
ioR.type = "recipe"
ioR.name = Constants.NetworkCables.externalIO.name
ioR.energy_required = 1
ioR.enabled = true
ioR.ingredients = {}
ioR.result = Constants.NetworkCables.externalIO.name
ioR.result_count = 1
data:extend{ioR}
]]
...
ioE.name = Constants.NetworkCables.externalIO.name
ioE.icon = Constants.NetworkCables.externalIO.itemIcon
ioE.icon_size = 512
...
ioE.minable = {mining_time = 0.2, result = Constants.NetworkCables.externalIO.name}
ioE.animation =
    {
        north = {
			layers = {
				{
					filename = Constants.NetworkCables.externalIO.entityE,
					priority = "extra-high",
                    size = 512,
					scale = 1/8,
					x=0
				...
				{
					filename = Constants.NetworkCables.externalIO.entityS,
					priority = "high",
                    size = 512,
					draw_as_shadow = true,
					scale = 1/8,
